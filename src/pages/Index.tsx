  ...
  const toys = [
    {
      ...
      features: ["Изучение 12 языков", "Проверка домашних заданий", "Родительские сценарии обучения", "Голографический интерфейс"]
    },
    {
      id: 2,
      ...
      features: ["Репетитор по 15 предметам", "Адаптивные программы обучения", "Контроль прогресса для родителей", "Эмоциональная поддержка"]
    },
    {
      id: 3,
      ...
      features: ["STEM-образование в игровой форме", "Языковые квесты в воздухе", "Настройка заданий родителями", "3D-проекция учебных материалов"]
    }
  ];
